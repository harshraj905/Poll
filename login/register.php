        ...
        <div class="container my-auto py-5">
          <div class="row">
            <div class="col-11 col-lg-10 mx-auto">
              ...
              <form id="registerForm" class="form-dark" method="POST">
                ...
                <div class="mb-3 mt-4">
                  <div class="form-check text-2">
                    ...
                    <label class="form-check-label text-light" for="agree">I agree to the <a href="#">Terms</a> and <a href="#">Privacy Policy</a>.</label>
                  </div>
                </div>
              ...
              <p class="text-2 text-center text-light">Already have an account? <a href="login.php">Sign In</a></p>
            </div>
          </div>
        </div>
      </div>
...
$passwrd = $_POST['loginPassword'];

 
if(isset($_POST['login']))
{
  $checkEntry = mysqli_query($config,"SELECT * FROM login WHERE email = '$eml' OR password='$passwrd'");
  ...
  {
    mysqli_query($config,"INSERT INTO login(fullname,email,password) VALUES('$usrnm','$eml','$passwrd')");
